...
class ShopList extends StatefulWidget {
  ...
  ShopList({Key? key, this.para, this.id}) : super(key: key);
...
class _ShopListState extends State<ShopList> {
                    ...
                    children: [
                      Padding(
                        ...
                        child:   Card(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>GetEnterpriseData(
                               shopData:snapshot.data![index],
                              )));
                            },
                            child: Stack(
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 10,),
                                          Text(snapshot.data![index].dname!,textAlign: TextAlign.center,
                                            style: TextStyle(color: Colors.white,
                                                fontWeight: FontWeight.bold,fontSize: 18,
                                                ),),
                                        ],
  ...
  Future<List<shoplist>> _shopData() async {
    ...
    // var url = Uri.parse("https://smartlockerindia.com/ajapi/api/Mobile_app/getshop_data");
    print('bbbbbbbb');
    print(url);
    print('ccccccccc');
