...
class SalesPerson extends StatefulWidget {
  final String? para;
  final String? id;
  SalesPerson({Key? key, this.para, this.id}) : super(key: key);
...
class _SalesPersonState extends State<SalesPerson> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<List<salesperson>>(
            future: _salesPerson()    ,
                  ...
                  itemBuilder: ((context, index) {
                    return  Padding(
                        ...
                        child:GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ShopList(para:'sales=', id:snapshot.data![index].id)));
                          },
                          child: Card(
                    ...
                    //             Navigator.push(context, MaterialPageRoute(builder: (context)=>ShopList(para:'sales=', id:snapshot.data![index].id)));
                    //
                    //             // Navigator.push(context, MaterialPageRoute(builder: (context)=>SalesShopList(para:'sales=', id:snapshot.data![index].id)));
                    //           },
                    //           child: Stack(
                    //             children: [
                    //               Container(
  ...
  Future<List<salesperson>> _salesPerson() async {
    print('raja');
    ...
    var url = Uri.parse("https://smartlockerindia.com/ajapi/api/Mobile_app/alssuserlist?$paras&type=5");
    print(url);
    var response = await http.get(url);
    var data = json.decode(response.body)['user'];
    print(data);
    print('janu');
    List<salesperson> allround = [];
    for (var o in data) {
      salesperson al = salesperson(
        o["id"],
        o["dname"],
        o["contact_email"],
        o["dp_officername"],
